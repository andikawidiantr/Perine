...
import id.progmob.perine.anggota.riwayatpeminjaman;
import id.progmob.perine.koneksi;
import id.progmob.perine.model.DataPinjam;

public class RiwayatAdapter extends RecyclerView.Adapter<id.progmob.perine.adapter.RiwayatAdapter.ViewHolder> {
    ...
    private id.progmob.perine.adapter.RiwayatAdapter adapter;

    String tag_json_obj = "json_obj_req";
    // membuat kontruksi recyclerviewadapter
    public RiwayatAdapter(Context context, ArrayList<DataPinjam> arrayModelPinjam) {
    ...
    @NonNull
    @Override
    public id.progmob.perine.adapter.RiwayatAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // membuat layout inflater
        View view = LayoutInflater.from(context).inflate(R.layout.card_transaksi, parent, false);
        return new id.progmob.perine.adapter.RiwayatAdapter.ViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull id.progmob.perine.adapter.RiwayatAdapter.ViewHolder holder, int position) {
