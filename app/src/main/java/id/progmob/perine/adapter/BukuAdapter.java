...
//    ArrayList<DataBuku> arrayModelBarangs = new ArrayList<DataBuku>();
    ...
    public BukuAdapter(Context context, ArrayList<DataBuku> arrayModelBarangs) {
...
//                                        lihatDataBarang(modelBarang);
                                        ...
                                        Intent intent = new Intent(context, editbuku.class);
...
//                                        Toast.makeText(context, arraybuku.getId() , Toast.LENGTH_SHORT).show();
...
//                                        Toast.makeText(context, String.valueOf(arraybuku), Toast.LENGTH_LONG).show();
                                        String url_delete = koneksi.isi_konten()+"deletebuku/"+arraybuku.getId();
